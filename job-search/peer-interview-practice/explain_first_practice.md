# Peer-to-peer live coding practice: abrupt coders
...
1. In a big group, read the theory lesson [Deal with common issues during live coding: abrupt coders](https://github.com/matovu-farid/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/explain_first_lesson.md).
...
2. In each interview, follow these steps:
   ...
   - \*\*The applicant job is to apply the following the guidelines from [Deal with common issues during live coding: abrupt coders](https://github.com/matovu-farid/curriculum-professional-skills/blob/main/job-search/peer-interview-practice/explain_first_lesson.md)
